"""
Custom KubeSpawner and an API handler for projects to be used in persistent
...
DEFAULT_PROVIDERS = (
    ...
    {
        "prefix": "hydroshare",
        "name": "Hydroshare resource",
        "hostname": "hydroshare.org",
    },
...
class PersistentBinderSpawner(KubeSpawner):
    ...
    - copies launched project's data (repo content) into a separate directory by
      ...
      This is particularly important because projects may use further features of
      repo2docker such as the postBuild script.
    ...
    def start(self):
        ...
        if (
            ...
            if projects and projects[-1].get("image"):
                ...
                self.image = "gesiscss/binder-gesiscss-2dpersistent-5fbinderhub-ab107f:0.2.0-n676"
                self.ref = self.image.split(":")[-1]
        self.log.info(
